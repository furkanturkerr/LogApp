<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CargoAdd.aspx.cs" Inherits="LogApp.CargoAdd" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            Tür<asp:DropDownList ID="tur_list" runat="server" AutoPostBack="True">
            ...
            <br />
            <asp:Button ID="yuk_ekle" runat="server" Text="Yük Ekle" OnClick="yuk_ekle_Click" />
        </div>
    </form>
</body>
</html>