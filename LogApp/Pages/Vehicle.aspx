<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vehicle.aspx.cs" Inherits="LogApp.Vehicle" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <asp:Button ID="arac_ekle_btn" runat="server" Text="Araç Ekle" OnClick="arac_ekle_btn_Click" />
        </div>
    </form>
</body>
</html>
