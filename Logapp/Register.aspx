<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Register.aspx.vb" Inherits="Logapp.Register" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="radio-group">
                <input type="radio" id="yuk_veren" name="yuk_turu" class="radio-btn" />
                <label for="yuk_veren">Yük Veren</label>

                <input type="radio" id="yuk_arayan" name="yuk_turu" class="radio-btn" />
                <label for="yuk_arayan">Yük Arayan</label>
            </div>
            ...
            <asp:Button ID="kayıt_btn" runat="server" Text="Kayıt Ol" CssClass="btn" />
        </div>
    </form>
</body>
</html>
